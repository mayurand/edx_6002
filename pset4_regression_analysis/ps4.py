...
def evaluate_models_on_training(x, y, models):
    ...
    for model in models:
        ...
        r_sqrd.append(r_squared(y, estYVals))
        pylab.figure()
        pylab.plot(x, y, 'bo',label = 'Data Points')
        pylab.plot(x, estYVals, 'r',label = 'Model fit')
        #pylab.plot(x, estYVals, 'r',label = 'Model fit'+ str(1)\
        #           + ', R2 = ' + str(round(r_squared(y, estYVals), 5)))
        pylab.legend(loc = 'best')
        pylab.title("Linear Regression fit"+ ', R2 = ' + str(round(r_squared(y, estYVals), 5)))
        pylab.xlabel('Years')
        pylab.ylabel('Temperature in degree C')
        pylab.show()
    return None
